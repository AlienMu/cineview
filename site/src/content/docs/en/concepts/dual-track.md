...
3. When animation misbehaves, first ask "who is writing right now", then "which snapshot did the declaration enter"; both questions have exactly one answer, and only then start changing code.
